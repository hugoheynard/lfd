 ...
 * c'est en réalité un fait d'entreprise. **Cette ligne** bascule, et les cinq
 * écrans suivent — pas une chasse au trésor dans deux fronts.
 *
 ...
 */
export const DELIVERY_SERVICE_OPEN = true;
