...
> 🔴 **Ce fichier a été VIDÉ le 2026-09-06, et restauré le 2026-09-07.**
>
> Le commit `4faf6783` (« une porte sur l'unité de l'argent ») a supprimé ses
> **888 lignes** sans que son message le mentionne : un dommage collatéral, pas
> une décision. Pendant vingt-quatre heures, les règles que tout le dépôt cite —
> la hiérarchie des garde-fous, le port du temps, la matrice des frontières,
> quand `vitruve` est obligatoire — n'étaient opposables **nulle part**. Seuls
> les deux fronts avaient le leur.
>
> **Ce qui est restauré est l'état du 2026-09-03** (`fac344e9`), la dernière
> version non vide. Vérifié à la restauration : les six chemins `documentation/`
> qu'il cite existent tous, et aucun nom de fichier qu'il mentionne n'a disparu.
>
> **Ce qu'il ne sait pas**, faute d'avoir vécu ces trois jours :
>
> - le §10 annonçait **23 portes** ; il y en avait **26** au 2026-09-07, et
>   **28** depuis le 2026-09-08 (`lint:business-day`, `lint:price-pipeline`) et
...
>   franchie quand même »). C'est la **seule**
...
>   client, l'écran de QR de retrait, l'idempotence de passation.
>
> **Ces trous ne sont pas comblés ici, et c'est délibéré.** Une doc périmée gèle
> un chantier ; une doc réécrite de mémoire en fait dérailler plusieurs. Ce qui
> suit est le texte d'origine, mot pour mot.
...
pnpm test
pnpm build
pnpm lint:gates         # les 29 portes du dépôt, d'un coup
