...
/**
 * Schéma « du contexte à l'outil » — le chemin complet, et les deux étages
 * qu'on confond toujours.
 *
 * **Un** contexte « sur place » : un taux réglé une fois par article, un
 ...
 *
 * Il a d'abord été dessiné avec DEUX contextes (« sur place QR », « sur place
 ...
 * ne se voit que sur une facture. Deux contextes ne se justifient que si les
