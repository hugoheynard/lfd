...
/**
 * Le **retrait au comptoir**, côté staff. Deux appels et rien d'autre : lire ce
 * qu'un QR désigne, puis attester.
 *
 * Sans état : chaque scan est un événement isolé, et deux retraits successifs
 ...
 * 2026-09-07, puis `/admin/handover` le 2026-09-10, quand le retrait a pris son
...
export class HandoverService {
  ...
  /** Atteste le retrait ; rend l'attestation obtenue (qui, quand). */
