...
export const KEY_LABELS: Readonly<Record<string, string>> = {
  ...
  hash: 'Empreinte',
  height: 'Hauteur',
  hiddenSkus: 'Articles retirés de la sélection',
  holder: 'Titulaire',
  ics: 'Identifiant créancier (ICS)',
  id: 'Identifiant',
  image: 'Image',
  ingredients: 'Ingrédients',
  isHidden: 'Opération masquée',
  it: 'Italien',
  key: 'Clé',
  kind: 'Sorte',
  label: 'Libellé',
  ...
  orderUntil: 'Clôture des commandes',
  origin: 'Origine',
  owner: 'Détenteur',
  ...
  pickupFrom: 'Premier jour de retrait',
  pickupUntil: 'Dernier jour de retrait',
