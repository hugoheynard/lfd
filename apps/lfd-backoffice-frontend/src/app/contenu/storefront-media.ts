 ...
 * « L'image se règle sur l'objet »). Fonctions pures ; état LOCAL seulement.
 */

import type { PlacedBlock, StorefrontShape } from './storefront-grid';
import { MOBILE_COLUMNS, mobileFormat } from './storefront-mobile';
...
export type MediaSide = 'left' | 'right' | 'top' | 'full';
