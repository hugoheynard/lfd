 ...
 *
 * Le contenu est projeté : ce cadre ne sait rien de ce qu'il encadre. Les trois
...
export class SupervisionColumn {
  ...
  /** En mobile, l'intitulé passe dans la barre de l'écran : la colonne ne le répète pas. */
