...
/**
 * **Les attestations de retrait du fournil** — les lire, en graver une.
 *
 * Un port étroit : deux méthodes, pas un CRUD. Le retrait n'a pas de cycle de vie
 * — il arrive une fois et ne bouge plus. Il n'y a donc rien à mettre à jour,
...
export abstract class OrderHandoverRepository {
   ...
   * au même instant produisent exactement un retrait, et le perdant l'apprend
  ...
  // la production qui déclare ce dont elle a besoin, et l'adaptateur du
  // retrait l'implémente. Un dépôt d'écriture n'est pas une surface de lecture
