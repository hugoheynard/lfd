...
/**
 * **Ce que le retrait répond au fournil**, et rien d'autre.
 *
 * Un adaptateur séparé du dépôt d'écriture, alors que les deux lisent la même
 * table. Ce n'est pas de la cérémonie : le dépôt sert **l'agrégat** du
 * retrait, ce port sert **une question** que pose un autre contexte. Les fondre
