 ...
 *
 * Le fournil constate le retrait ; il ne connaît pas la commande. Il déclare donc
 ...
 *
 * ⚠️ **Aucun champ de retrait**. `handedOverAt`, `handedOverBy`, `handedOverVia`
...
export interface HandoverSubject {
  ...
  /** Le client à qui elle appartient — le sujet de la trace de retrait. */
...
export abstract class HandoverSubjectReader {
  /**
   * La commande derrière ce **jeton de retrait**, ou `null` s'il n'ouvre rien.
   *
   ...
   * cette porte est la session staff, et c'est suffisant parce que saisir un
   * retrait est un acte dont l'auteur est enregistré.
   */
   ...
   * étage — sur un poste où quelqu'un attend en face. Les trois vues de retrait
