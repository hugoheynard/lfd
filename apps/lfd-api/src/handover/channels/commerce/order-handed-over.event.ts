...
/**
 * **Une commande a été retirée** — constaté au comptoir du fournil.
 *
 ...
 * volontaire : il n'y a **rien** à distinguer entre « retrait constaté » et
 * « commande retirée ». Le jour où il y aurait quelque chose — un retour, un
 * retrait partiel —, ce sera le signe qu'ils doivent se séparer.
 *
 * ## Ce qu'il porte
 *
 ...
 * recopie dans son snapshot — sans lui, un retrait saisi deviendrait un scan en
