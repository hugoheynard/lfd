 ...
 * - `suspended` — accès coupé **temporairement** (impayé, litige), réversible.
 * - `terminated` — **fin de la relation commerciale**, définitif côté métier ;
 *   l'historique reste, mais on ne réactive pas (on recrée une société au besoin).
 *
