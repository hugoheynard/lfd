/**
 * **Ce que le fournil a besoin de savoir du retrait** — et rien de plus.
 *
 ...
 *
 * 🔴 **C'est la production qui DÉCLARE ce port, et le retrait qui l'implémente.**
 ...
 *
 * ⚠️ La méthode vivait sur `OrderHandoverRepository`, le port d'ÉCRITURE du
 * retrait, et le fournil l'appelait en direct. Ça marchait tant que les deux
