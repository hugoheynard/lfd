 ...
 *
 * Une **projection de lecture**, pas un état de l'agrégat : `VatRate` n'a
 ...
 */
export abstract class VatRateRepository {
  abstract listAll(): Promise<VatRate[]>;
   ...
   */
  abstract usageByRegime(): Promise<ReadonlyMap<string, VatRateUsage>>;
}
