/**
 * **Quels emplacements existent** — la face manquante d'un mur à une seule face.
 *
 ...
 * `DeleteEmplacement` en tire la conséquence et refuse de supprimer un
 ...
 */
export abstract class KnownEmplacementsReader {
