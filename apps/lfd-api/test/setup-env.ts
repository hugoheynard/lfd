...
process.env["R2_CUSTOMERS_EU_BUCKET"] = TEST_BUCKETS.customers;
process.env["R2_CUSTOMERS_EU_ACCESS_KEY_ID"] = TEST_STORAGE.accessKeyId;
process.env["R2_CUSTOMERS_EU_SECRET_ACCESS_KEY"] = TEST_STORAGE.secretAccessKey;
