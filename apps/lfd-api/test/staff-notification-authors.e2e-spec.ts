 ...
 * 2026-09-18) : `StaffNotification.readBy` et `StaffPushSubscription.staffSub`.
 * La colonne de la seconde garde son nom jusqu'à l'étape 5 ; ce qu'elle reçoit
 * change maintenant, et seul le vrai Postgres le montre.
 *
