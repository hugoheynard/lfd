...
/**
 * Fondations **cross-cutting** : les ports `Clock`, `IdGenerator` et
 * `SecretGenerator`, câblés sur leurs adaptateurs de production. `@Global` →
...
@Module({
  ...
  exports: [Clock, IdGenerator, SecretGenerator],
})
