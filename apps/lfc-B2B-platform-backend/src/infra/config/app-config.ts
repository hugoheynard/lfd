...
export class AppConfig {
  ...
  /**
   * URL de connexion **Prisma Postgres** (`prisma+postgres://…`, via Accelerate).
   * Nommée `DATABASE_B2B_URL` — préfixée par app pour ne pas collisionner avec
   * les autres bases (admin, PIM) si les env se partagent un jour.
   */
  databaseUrl(): string {
