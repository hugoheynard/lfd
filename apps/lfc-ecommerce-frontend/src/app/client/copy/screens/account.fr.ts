...
export const ACCOUNT_FR: AccountCopy = {
  ...
  profilePageLead: 'Qui vous êtes, et comment vous entrez dans votre compte.',
  profileIdentityTitle: 'Identité',
  profileFirstName: 'Prénom',
  profileLastName: 'Nom',
  profileEmail: 'E-mail',
  profileIdentitySubtitle: 'Vos coordonnées personnelles, visibles de nous seuls.',
  profileEmailChange:
  ...
  loginMethodsTitle: 'Méthodes de connexion',
  loginMethodsSubtitle: 'Ce avec quoi vous entrez dans votre compte.',
  loginMethodsLoading: 'Lecture de vos méthodes de connexion…',
  loginMethodsFailed: 'Impossible de lire vos méthodes de connexion.',
  loginMethodsRetry: 'Réessayer',
  loginMethodsEmpty: 'Aucune méthode de connexion',
  loginMethodsEmptyHint: 'Ajoutez-en une pour entrer plus vite la prochaine fois.',
  loginMethodPrimary: 'Méthode principale',
  loginMethodsAdd: 'En ajouter une',
  loginMethodAdd: 'Ajouter {provider}',
  loginMethodsPromise: 'Vous vous connecterez au même compte, avec les mêmes commandes.',
  loginMethodRemove: 'Retirer',
  loginMethodRemoveMessage:
    'Vous ne pourrez plus entrer avec. Rien n’est supprimé chez le fournisseur : ce compte y redevient autonome.',
  loginMethodRemoveConfirm: 'Oui, retirer',
  loginMethodRemoveBusy: 'Retrait…',
  loginMethodRemoveGroup: 'Confirmer le retrait de cette méthode de connexion',
  ...
  loginMethodEmailChangeTitle: 'Changer mon adresse de connexion',
  loginMethodEmailCurrent: 'Adresse actuelle',
  loginMethodEmailNew: 'Nouvelle adresse e-mail',
  loginMethodEmailConfirm: 'Confirmer la nouvelle adresse',
  loginMethodEmailMismatch: 'Les deux adresses ne sont pas identiques.',
  loginMethodEmailSame: 'C’est déjà votre adresse de connexion.',
  loginMethodPasswordChange: 'Changer mon mot de passe',
  loginMethodPasswordSent: 'Un lien vous a été envoyé.',
  loginMethodPasswordFailed: 'Le lien n’a pas pu être envoyé.',
  proAccountTitle: 'Ouvrir un compte professionnel',
  proAccountLead:
    'Commandez au nom de votre établissement, aux tarifs professionnels, avec une facture à son nom.',
  proAccountLink: 'Ouvrir un compte pro',
  proAccountsTitle: 'Mes comptes professionnels',
  proAccountsLead:
    'Les entreprises auxquelles vous êtes rattaché. Basculez dans l’une d’elles depuis le menu du compte.',
  proAccountAnother: 'Ouvrir un autre compte pro',
