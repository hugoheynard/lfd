...
export const ACCOUNT_EN: AccountCopy = {
  ...
  profilePageLead: 'Who you are, and how you sign in to your account.',
  profileIdentityTitle: 'Identity',
  profileFirstName: 'First name',
  profileLastName: 'Last name',
  profileEmail: 'E-mail',
  profileIdentitySubtitle: 'Your personal details, seen only by us.',
  profileEmailChange:
  ...
  loginMethodsSubtitle: 'What you use to get into your account.',
  loginMethodsLoading: 'Reading your sign-in methods…',
  loginMethodsFailed: 'Your sign-in methods could not be read.',
  loginMethodsRetry: 'Try again',
  loginMethodsEmpty: 'No sign-in method',
  loginMethodsEmptyHint: 'Add one to get in faster next time.',
  loginMethodPrimary: 'Primary method',
  loginMethodsAdd: 'Add one',
  loginMethodAdd: 'Add {provider}',
  loginMethodsPromise: 'You will sign in to the same account, with the same orders.',
  loginMethodRemove: 'Remove',
  loginMethodRemoveMessage:
    'You will no longer get in with it. Nothing is deleted at the provider: that account becomes standalone again there.',
  loginMethodRemoveConfirm: 'Yes, remove',
  loginMethodRemoveBusy: 'Removing…',
  loginMethodRemoveGroup: 'Confirm removing this sign-in method',
  ...
  loginMethodEmailChangeTitle: 'Change my sign-in address',
  loginMethodEmailCurrent: 'Current address',
  loginMethodEmailNew: 'New email address',
  loginMethodEmailConfirm: 'Confirm the new address',
  loginMethodEmailMismatch: 'The two addresses do not match.',
  loginMethodEmailSame: 'This is already your sign-in address.',
  loginMethodPasswordChange: 'Change my password',
  loginMethodPasswordSent: 'A link has been sent to you.',
  loginMethodPasswordFailed: 'The link could not be sent.',
  proAccountTitle: 'Open a business account',
  proAccountLead:
    'Order on behalf of your business, at professional rates, with an invoice in its name.',
  proAccountLink: 'Open a business account',
  proAccountsTitle: 'My business accounts',
  proAccountsLead: 'The companies you belong to. Switch to one of them from the account menu.',
  proAccountAnother: 'Open another business account',
