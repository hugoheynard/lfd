...
export const FR: ClientCopy = {
  ...
  shop: {
    ...
    openFeatureShelf: 'Ouvrir le rayon',
    slidePrevious: 'Contenu précédent',
    slideNext: 'Contenu suivant',
    slideGoTo: 'Contenu {n} sur {count}',
    ...
    operationBadgeFrom: 'Dès le {date}',
    operationBadgeDays: 'J‑{days}',
    operationBadgeLastDay: 'Dernier jour',
  },
  product: {
    bestSeller: 'Best-seller',
    oven: 'Fournée',
    operationPickup: 'Retrait',
    operationPickupSpan: 'du {from} au {until}',
    operationPickupDay: 'le {day}',
    perPiece: '/ pièce',
    proDiscount: 'Prix pro −{pct} %',
    batch: '× {n}',
    batchAria: '{n} pièces',
    addCount: 'Ajouter {n}',
