...
export const FR: ClientCopy = {
  ...
  espace: {
    ...
    pickupWhen: 'Prête au {at} · dès {slot}',
    pickupAction: 'Mon QR',
  ...
  shop: {
    ...
    loading: 'Le rayon arrive…',
    loadFailedTitle: 'La boutique n’a pas pu se charger',
    loadFailedHint: 'Le réseau n’a pas répondu. Rien n’est perdu : votre panier vous attend.',
    loadRetry: 'Réessayer',
  ...
  pay: {
    ...
    lead: 'Votre commande {ref} est enregistrée. Elle part en fabrication une fois réglée.',
    ...
    kicker: 'Confirmée',
    title: 'C’est réglé.\nOn s’y met à 4 h 15.',
    titleDue: 'Commande enregistrée.\nIl reste à la régler.',
    titleAccount: 'Commande enregistrée.\nElle part sur votre compte.',
    intro: 'Votre commande entre dans la fournée de demain matin.',
    keptTitle: 'Gardée dans votre espace',
  ...
  pickupDialog: {
    kicker: 'Retrait',
    title: 'Vous venez où ?',
    whenTitle: 'Vous venez quand ?',
    lead: 'On aime vous recevoir : retirez sur place et profitez d’une remise de {value} sur votre commande.',
  ...
  slotStep: {
    ...
    free: 'ouvert',
    proOnly: 'réservé aux pros',
    before: 'avant',
    noneTitle: 'Aucune heure déclarée',
    noneSubtitle: 'Ce point n’a pas encore publié ses horaires. Appelez-nous, on vous cale.',
