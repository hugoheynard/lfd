...
export const ACCOUNT_FR: AccountCopy = {
  ...
  mandateOptionsDebtorReference: 'Code identifiant du débiteur',
  mandateOptionsDebtorReferenceHint:
    'La référence que vous voulez voir revenir sur vos relevés bancaires.',
  mandateOptionsContractNumber: 'Numéro du contrat',
  mandateOptionsContractNumberHint: 'Facultatif.',
