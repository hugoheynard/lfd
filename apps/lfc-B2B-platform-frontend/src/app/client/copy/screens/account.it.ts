...
export const ACCOUNT_IT: AccountCopy = {
  ...
  mandateOptionsDebtorReference: 'Codice identificativo del debitore',
  mandateOptionsDebtorReferenceHint:
    'Il riferimento che volete ritrovare sui vostri estratti conto.',
  mandateOptionsContractNumber: 'Numero del contratto',
  mandateOptionsContractNumberHint: 'Facoltativo.',
