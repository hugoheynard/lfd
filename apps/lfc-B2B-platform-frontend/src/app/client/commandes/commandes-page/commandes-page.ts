...
import { MOCK_HISTORY, MOCK_ORDER_TOTALS, MOCK_TRACKED } from '../../mock-orders';
...
export class CommandesPage {
  ...
  protected readonly accountTotal = formatEuro(MOCK_ORDER_TOTALS.accountTotal);
  protected readonly accountNote = MOCK_ORDER_TOTALS.accountNote;
  protected readonly cardTotal = formatEuro(MOCK_ORDER_TOTALS.cardTotal);
  protected readonly cardNote = MOCK_ORDER_TOTALS.cardNote;
