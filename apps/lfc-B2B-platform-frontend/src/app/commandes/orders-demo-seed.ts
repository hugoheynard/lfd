...
const TEMPLATES: readonly DemoTemplate[] = [
  ...
  { status: 'fulfilled', monthsAgo: 0, day: 10, place: 'Boutique principale', totalEur: 64.5, paid: true },
  { status: 'fulfilled', monthsAgo: 1, day: 28, place: 'Boutique principale', totalEur: 96.8 },
  { status: 'fulfilled', monthsAgo: 1, day: 22, place: 'Boutique principale', totalEur: 158.4, paid: true },
  { status: 'fulfilled', monthsAgo: 1, day: 27, place: 'Entrepôt Nord', totalEur: 331.2, paid: true },
  { status: 'fulfilled', monthsAgo: 1, day: 16, place: 'Boutique principale', totalEur: 45.9, paid: true },
  { status: 'fulfilled', monthsAgo: 1, day: 9, place: 'Boutique principale', totalEur: 214.0, paid: true },
  ...
  { status: 'fulfilled', monthsAgo: 2, day: 3, place: 'Entrepôt Nord', totalEur: 120.0, paid: true },
];
