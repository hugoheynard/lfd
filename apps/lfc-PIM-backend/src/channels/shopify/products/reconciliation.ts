...
function sortVariants(
  variants: readonly ComparableVariant[],
): ComparableVariant[] {
...
export function comparableFromPayload(
...
export function comparableFromRemote(
...
export function diffComparable(
  ...
  push(
    diffs,
    'Déclinaisons',
    describeVariants(before.variants),
    describeVariants(after.variants),
  );
  return diffs;
}
