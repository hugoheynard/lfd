...
@Component({
  ...
  imports: [RouterLink, FoldPageLayoutComponent, FoldDataTableComponent, FoldDataTableCellDirective, FoldButtonComponent, FoldCalloutComponent, FoldBadgeComponent, FoldSearchComponent, FoldPaginatorComponent, FoldDropdownComponent, FoldDropdownItemComponent, FoldPopoverTriggerDirective, FoldIconComponent, FoldElementTitleComponent],
