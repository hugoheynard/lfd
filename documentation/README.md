...
| [`b2b/architecture-catalogue-synchronise.md`](b2b/architecture-catalogue-synchronise.md)               | 📐   | **Le PIM pousse, la plateforme accueille et altère.** La plateforme est un canal du PIM ; le reçu et l'altéré ne partagent pas leurs colonnes. Altérable = prix + visibilité. Rien n'est codé — le catalogue est encore copié **trois fois**.               |
