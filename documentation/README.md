...
| [`b2b/architecture-engagement-vendor-buyer.md`](b2b/architecture-engagement-vendor-buyer.md)           | 🔵   | **Qui porte le risque de prix ?** Note de conception, zéro code. `vendor lock` (le client subit les hausses) vs `buyer lock` (il bloque un volume et fige son prix d'entrée) — le contrat brasseur. L'indicateur qui décide d'activer une promo sur le chemin sous contrat, et le piège de la régularisation. |
