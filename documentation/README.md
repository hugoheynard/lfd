...
| [`b2b/architecture-resolution-de-prix.md`](b2b/architecture-resolution-de-prix.md)                     | 🟡   | Le prix comme **empilement d'étages datés**. Les 3 forks sont tranchés et **S1 est livré** (domaine pur, 32 tests) : composition, arrondi unique en `bigint`, plancher à deux formes. S2→S5 pas commencés.                                                                 |
