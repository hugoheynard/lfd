...
| [`b2b/decision-discretion-recherche-personnes.md`](b2b/decision-discretion-recherche-personnes.md)     | ✅   | **On ne cherche pas les personnes** : l'adresse est la seule clé, l'écran ne dit jamais qu'elle est déjà connue. Qui travaille avec qui ne se répand pas.                                       |
...
| [`todos/post-release-detention-et-acces.md`](todos/post-release-detention-et-acces.md) | 📐   | **Post-release** : transfert de détention (passation/vente/décès), révocation d'accès depuis l'admin, balayage des invitations périmées. |
