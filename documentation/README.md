...
| [`b2b/architecture-resolution-de-prix.md`](b2b/architecture-resolution-de-prix.md)                     | 📐   | Le prix comme **empilement d'étages datés** : override DANS un étage, cumul ENTRE étages. `replace` (mercuriale) ≠ `alter`. **Les 3 forks sont tranchés** (2026-08-17) — S1 débloqué. Rien n'est codé.                                                                     |
