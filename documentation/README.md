...
| [`b2b/architecture-facturation-mensuelle.md`](b2b/architecture-facturation-mensuelle.md)               | 📐   | **La boucle qui manque** : une commande sur terme différé n'est ni facturée ni prélevée. Facture in-app (agrégat figé + numérotation sans trou), cycle idempotent, 8 tranches. Rien n'est codé.                                                             |
