...
| [`b2b/architecture-resolution-de-prix.md`](b2b/architecture-resolution-de-prix.md)                     | 📐   | Le prix comme **empilement d'étages datés** : override DANS un étage, cumul ENTRE étages. `replace` (mercuriale) ≠ `alter`. **3 décisions produit ouvertes** bloquent S1. Rien n'est codé.                                                                                 |
