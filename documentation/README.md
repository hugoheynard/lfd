...
| [`b2b/architecture-commande-immuable-avenants.md`](b2b/architecture-commande-immuable-avenants.md)     | 📐   | La commande est close ; les modifications sont des **avenants**. Et pourquoi le récapitulatif doit venir du serveur. |
