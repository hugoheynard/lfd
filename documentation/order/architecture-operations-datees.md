...
sur la famille — son id du référentiel depuis le 2026-09-26, `b2b/catalog/domain/catalog-family.ts`). L'opération
...
| ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Rayons de la boutique  | `b2b/catalog/application/shop-catalogue-view.ts:43` (`shelfId = item.categoryId`), la table en dur des rayons (retirée le 2026-09-26) | un rayon **est** une famille du PIM, liste fermée en dur. Un rayon d'opération ne peut pas en naître : il lui faut sa propre clé, `op:<key>`.                                                                                                                       |
