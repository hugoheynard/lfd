...
| **Opération** | « Le rayon de Noël, J‑18 »                 | une sélection d'articles, sa fenêtre de dates, son délai de commande                 | `operation_key` sur l'info ; la lecture publique éteint ou hérite (D11 de `architecture-operations-datees.md`) | ✅ serveur fait (2026-09-24) — éditeur et boutique à venir               |
