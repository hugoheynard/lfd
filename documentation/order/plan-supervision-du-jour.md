...
| Bande de compteurs                        | 3 chiffres de 22 px sur `#131a28`, étiquettes Mono au-dessus | **masthead** de la page : `fold-page-section bleed foldSurface="chrome"`, une ligne « **5** lignes ouvertes · **4** commandes à coliser · **4** attendues · dont 1 livraison » en `--fold-text-sm`, chiffres semi-gras | même composant et même traitement que Retrait boutique                                                                                                                                                                                                                                               |
| Date et fraîcheur                         | dans la barre graphite, « jeudi 3 septembre · 6 h 40 »       | à droite du masthead, Mono : « jeudi 3 septembre · à jour à 6 h 40 »                                                                                                                                                   | là où Retrait boutique met ses méta ; l'heure est celle de la lecture du serveur (`asOf`)                                                                                                                                                                                                            |
