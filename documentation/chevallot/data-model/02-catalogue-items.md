...
> **Descopé v1** : la couche ⚖️ *physique / logistique* (poids, dimensions, unités logistiques,
...
tel quel. Il reste ici car il définit *ce qu'est* le produit.
...
Arbre à **parent unique**. C'est le classement *structurel* (« Viennoiseries »), pas le marketing.
