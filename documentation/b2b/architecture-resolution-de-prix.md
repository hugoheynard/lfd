...
La bande du catalogue porte donc une **frise** : une ligne par règle sur un
axe de dates commun, et sous les barres, les tranches où plusieurs règles
sont en vigueur. Le recouvrement se **voit** au lieu de se déduire en
comparant quatre dates de tête.
