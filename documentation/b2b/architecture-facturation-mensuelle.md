...
| --- | ------------------------------ | --------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------- |
| 1   | **Réduire les termes**         | `deferredTermSchema` → `["monthly"]`, reprise des sociétés en net60/net90 (seed : rien à conserver), écrans nettoyés. | Une société ne peut plus se voir accorder que le mensuel.                          |
