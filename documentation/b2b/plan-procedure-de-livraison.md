...
| Routes staff `/admin/companies/:companyId/delivery-addresses/…` sous `@AdminSurface("b2b_companies")`, faits `*ByStaffEvent` publiés en transaction | `account/http/admin-company-pieces.controller.ts`, `admin-address.handlers.ts`           |
