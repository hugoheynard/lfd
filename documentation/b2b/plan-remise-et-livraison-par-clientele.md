...
| Back-office : une page « Retraits et livraisons » — carte des points, section des zones, section des heures limites ; la réduction se saisit par `lfd-price-alteration-field` dans le panneau du point                                                      | `apps/lfd-backoffice-frontend/src/app/reglages/retraits-livraisons/`                                                                                |
| Boutique : la remise se lit sur la carte « Je passe le prendre », dans le dialogue de retrait, dans le bloc pro de Mon espace ; la livraison s'ouvre par la carte « On vous l'apporte » et son dialogue d'adresse                                           | `apps/lfc-ecommerce-frontend/src/app/client/shop/pickup-discount.ts`, `client/mon-espace/pro-summary.ts`, `client/nouvelle-commande/commande-page/` |
