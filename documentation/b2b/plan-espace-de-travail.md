...
après la bascule). « Mon compte » (le dossier), « Mes factures » (le relevé) et « Paniers
récurrents » quittent le menu en perso, et `companyWorkspaceGuard` renvoie leurs adresses
