...
- **Agrégat `Lead`** ([`entities/lead.ts`](../../apps/lfd-api/src/b2b/growth/domain/entities/lead.ts)) :
...
([`prisma-admin-company.reader.ts:34`](../../apps/lfd-api/src/b2b/account/infrastructure/prisma-admin-company.reader.ts)) :
...
2. **Le client ne peut plus jamais redemander à être rappelé.** Le handler lève
   ...
   ([`request-activation-support.handler.ts`](../../apps/lfd-api/src/b2b/account/application/commands/request-activation-support.handler.ts)) —
