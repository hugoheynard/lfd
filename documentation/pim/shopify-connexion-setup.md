...
([`token-provider.ts`](../../apps/lfc-PIM-backend/src/channels/shopify/shared/token-provider.ts)) :
...
- Les coller dans `apps/lfc-PIM-backend/.env` (valeurs brutes, **sans guillemets ni
