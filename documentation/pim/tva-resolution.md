...
> quand il manque.
>
> État : ✅ décrit du code qui tourne, au 2026-08-24. Les deux points 📐 sont
> signalés comme tels.
...
flowchart TD
  subgraph PIM["PIM — la source"]
    ...
    P["<b>override produit</b><br/><i>📐 pas construit</i>"]
    R --> J
    C --> J
...
| override produit 📐    | le taux d'**un produit**, par contexte     | —                                      |
...
- **C0-c déployé ?** Le `DROP` des trois colonnes ne part qu'**après** la bascule.
- **C0-d** — la matrice des canaux reste à clés fixes ; `channel_key` meurt avec elle.
- **Override produit** 📐 — [`override-produit.md`](./override-produit.md).
- **Repli `billableRate`** — à retirer après le premier push complet.
