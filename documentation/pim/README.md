...
| [`architecture-prix-ancre-ttc.md`](./architecture-prix-ancre-ttc.md)         | **Le prix ancré au TTC et le rapport prix public / prix pro** (🚧 tranches 1-3/4) — pourquoi un second ancrage plutôt qu'un remplacement, où se range le rapport (global, dérivé, montant posé qui gagne) et où il ne se range PAS, la frontière « le B2B ne voit jamais de TTC », les quatre tranches                                                                                                                                      |
