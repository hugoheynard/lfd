...
| [`tva-resolution.md`](./tva-resolution.md)                                   | **La TVA, d'un bout à l'autre** (✅) — du référentiel des taux à la ligne de facture : les étages, les règles tenues par le code, ce que la boutique B2B et Shopify en font, et comment ajouter un contexte de vente                                                                                      |
