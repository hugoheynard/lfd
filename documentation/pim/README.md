...
| [`c0d-matrice-de-canaux.md`](./c0d-matrice-de-canaux.md)                     | **C0-d, la matrice pilotée par la donnée** (📐 note doc-first) — pourquoi « ajouter un contexte = une ligne » est FAUX aujourd'hui, où va le drapeau `b2b` (trois sorties, une retenue), le prérequis découvert au passage (un point de vente déclare les contextes qu'il offre), et le plan en quatre déploiements |
