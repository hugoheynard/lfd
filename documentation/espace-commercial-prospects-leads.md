...
> [`espace-commercial-prospects-leads-todo-tech.md`](espace-commercial-prospects-leads-todo-tech.md).
...
Trois exigences non négociables qui distinguent un *top* outil d'un tableau de bord :
...
> *transactionnelle* ; le **journal** est la vérité *analytique*. Les deux
...
> « pending qui paie par carte » indéfiniment — on ne le *close* pas (il achète
> déjà), on l'**upgrade**. ② Un **stalled vaut plus qu'un cold** : il *voulait*
...
adoption+ dit *combien* se convertit seul ; il ne dit pas si **nos actions
...
- **Tableau de bord** → *« que fais-je aujourd'hui ? »*
- **Listes** → *« qui ? »*
- **Fiche établissement** → *« pourquoi, et quoi ensuite ? »*
...
| 5 | **Calendrier / RDV** | *déjà prévu* | les rendez-vous, reliés à la fiche (un RDV = jalon + play) |
...
> **Démarchage (cold)** : au départ un **filtre `source = sortant`** dans *Prospects*
