...
| Un fait staff porte le `sub` de l'auteur en `actor_id` (converti depuis en id de fiche : [`../plan-l-auteur-est-la-fiche.md`](../plan-l-auteur-est-la-fiche.md)) | `admin-auth.guard.ts`                                           |
