...
> (concept), [`espace-commercial-prospects-leads-todo-tech.md`](espace-commercial-prospects-leads-todo-tech.md)
...
([`acquisition-events.ts:88`](../apps/lfc-B2B-admin-frontend/src/app/commercial/acquisition/acquisition-events.ts)) :
...
[`acquisition-page.ts`](../apps/lfc-B2B-admin-frontend/src/app/commercial/acquisition/acquisition-page.ts) :
...
| Projection calendrier (pure)            | `commercial/acquisition/acquisition-events.ts`                                                             |
| Onglet Acquisition                      | `commercial/acquisition/acquisition-page.ts`                                                               |
