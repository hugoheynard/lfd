...
[`data-model/00-langage-et-comportement.md`](../lfc/data-model/00-langage-et-comportement.md#5--les-trois-règles-irréversibles)) :
...
- **D6 est clos** : les frontières d'agrégat sont tranchées dans
  [`00-langage-et-comportement.md`](../lfc/data-model/00-langage-et-comportement.md#2--agrégats--la-décision-ex-d6)
...
- Détail : [`data-model/04-composition-et-canaux.md`](../lfc/data-model/04-composition-et-canaux.md).
...
- Détail : [`data-model/06-identifiants-et-sku.md`](../lfc/data-model/06-identifiants-et-sku.md).
