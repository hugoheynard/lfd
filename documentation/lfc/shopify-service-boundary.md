...
> [`architecture-suite-gateway-scaling.md`](../architecture-suite-gateway-scaling.md), [`adr.md#adr-13`](./adr.md).
...
- **Maintenant** : extraire la couche connexion en **package** `@lfd/shopify-client` (le
  *seam*) — token provider, transport `graphql`, réglages. Zéro déployable en plus. Le PIM
