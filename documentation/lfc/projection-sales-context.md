...
>
> Statut : **design cible.** Décidé le 2026-08-05 : on construit le modèle *expansible* plutôt
...
| **C4** *(inactif)* | Activer `surPlace` : projection multi-contexte (handles suffixés) + réconciliation par contexte | différé |
| **C5** *(futur)* | Contexte `b2b` (TVA 20 %) — pur ajout de config | futur |
