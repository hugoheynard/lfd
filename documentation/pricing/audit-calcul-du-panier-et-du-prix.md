...
| ~~**Le panier n'existe pas côté serveur**~~           | **Comblé le 2026-09-06** — `shop_carts`, un panier par personne (**par personne et par espace de travail** depuis le 2026-09-15 — `plan-espace-de-travail.md`, D9), `GET`/`PUT /shop/cart`. Reste local pour qui n'est **pas** reconnu : c'est une décision, la boutique se visite sans compte. | ✅ `P13`                                      |
