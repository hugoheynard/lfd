...
> Voisins : [`architecture-conditionnements-pricing.md`](architecture-conditionnements-pricing.md),
> [`audit-catalogue-boutique-b2b.md`](audit-catalogue-boutique-b2b.md).
...
- **Slice 1 — Produits (parité + rewire).** *(on commence ici)* Prisma `Product`/
